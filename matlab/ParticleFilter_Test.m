...
for i = 1:size(images,3)
    ...
    if i == 1
        imwrite(A,map,'../visualization/particle_path', 'gif','LoopCount',Inf,'DelayTime',1);
    else
        imwrite(A,map,'../visualization/particle_path','gif','WriteMode','append','DelayTime',1);
    end
